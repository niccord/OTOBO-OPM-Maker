...
use_ok 'OTOBO::OPM::Maker::Command::sopmtest';
...

{
    ...
    my $exec_output = capture_stdout {
        OTOBO::OPM::Maker::Command::sopmtest::execute( undef, {}, [ $textfile ] );
    };
...

{
    ...
    my $exec_output = capture_stdout {
        OTOBO::OPM::Maker::Command::sopmtest::execute( undef, {}, [ undef ] );
    };
...

{
    ...
    my $exec_output = capture_stdout {
        OTOBO::OPM::Maker::Command::sopmtest::execute( undef, {}, [ '/tmp/does/not/exist_yet.sopm' ] );
    };
...

{
    ...
    my $exec_output = capture_stdout {
        OTOBO::OPM::Maker::Command::sopmtest::execute( undef, {}, [ $invalid_xml ] );
    };
