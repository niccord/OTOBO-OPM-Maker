...
use_ok 'OTOBO::OPM::Maker::Command::dependencies';
...
my $output = q~TestPackage - 1.0 (OTOBO add on)
SMS::Send - 0.35 (CPAN module)
~;

{
    my $exec_output = capture_stdout {
        OTOBO::OPM::Maker::Command::dependencies::execute( undef, {}, [ $sopm ] );
    };
...
{
    my $exec_output = capture_stdout {
        OTOBO::OPM::Maker::Command::dependencies::execute( undef, {}, [ $opm ] );
    };
